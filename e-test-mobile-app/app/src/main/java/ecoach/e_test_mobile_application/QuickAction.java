...
public class QuickAction extends PopUpWindows {
    ...
    public void show(View anchor) {
        ...
        mRootView.setLayoutParams(new Gallery.LayoutParams(Gallery.LayoutParams.WRAP_CONTENT, Gallery.LayoutParams.WRAP_CONTENT));
        mRootView.measure(Gallery.LayoutParams.WRAP_CONTENT, Gallery.LayoutParams.WRAP_CONTENT);
